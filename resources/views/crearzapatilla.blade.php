...
<body>
    <form action="{{url('/crearzapatilla')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <p>Marca</p>
        <input type="text" name="marca_zapatilla">
        @error('marca_zapatilla')
        <br>
        {{$message}}
        @enderror
        <p>Modelo</p>
        <input type="text" name="modelo_zapatilla">
        @error('modelo_zapatilla')
        <br>
        {{$message}}
        @enderror
        <p>Color</p>
        <input type="text" name="color_zapatilla">
        ...
        @enderror
        <p>Precio</p>
        <input type="number" name="precio_zapatilla">
